...
exports.URL_PAYPAL_BASE = exports.URL_REACT_CLIENT = exports.URL_MERCADO_PAGO = exports.URL_SERVER = exports.URL_WEB_SITE = void 0;
const isLocalEnv_1 = __importDefault(require("../../functions/isLocalEnv"));
const console_1 = require("console");
exports.URL_WEB_SITE = "marcotuliomuniz.netlify.app";
exports.URL_SERVER = '';
exports.URL_MERCADO_PAGO = "https://api.mercadopago.com";
exports.URL_REACT_CLIENT = !(0, isLocalEnv_1.default)()
    ? `http://${exports.URL_WEB_SITE}`
    : 'http://localhost:3000';
